...
public class MainClass {
	...
	*/
	...
	/*
		...
		1. equals	
			...
			3) 객체의 값으로 동등 비교를 수행하기 위해서는 equals 메소드를 "오버라이드" 해야 함  ***************기억
		2. toString	
	...
	*/
	...
	public static void ex02() {
		...
		Person person1 = new Person("홍길동");			// object 클래스는 참조값을 비교하는 클래스
		Person person2 = new Person("홍길동");
		
		if(person1.equals(person2)) {					// 참조값 비교, person1, person2 참조값 다름
	...
	public static void ex03() {
		...
		System.out.println(person); 			// toString 메소드는 호출을 생략

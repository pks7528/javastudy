...
public class Ex01_array {
	...
	/*
		 ...
		 3. 배열이 생성되면 자동으로 초기화된다.
		 	0(int type), 0.0(double type), false(boolean type), null(참조 타입) 값으로 초기화된다. (값이 없음을 의미)
		 	
		 	배열은 값을 가짐 int a;  값은 garbage == 쓰레기
	 */
	...
	public static void ex01() {
		...
		System.out.println(arr[0]);					// 배열 요소
	...
	public static void ex05() { //연습
		...
		int total = 0; 	// Zero
		int max = 0; 	// 가장 작은 값
		int min = 100; 	// 가장 큰 값		// 최소값은 가질 수 있는 값 중에서 가장 큰 값을 입력
	...
	public static void ex08() { //1월 기준으로
	...
	public static void ex09() {
		...
		String[] season = { "겨울" , "봄", "여름", "가을" }; // (month % 12 ) / 3 .. 0 겨울 1 봄 2 여름

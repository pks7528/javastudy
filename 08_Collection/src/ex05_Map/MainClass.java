...
public class MainClass {
	...
	public static void ex01() {
		...
		/*
			...
			2. 용어 정리
				...
				3) Value : Entry의 구성 요소, 실제 데이터 (배열에 저장된 데이터)
	...
	public static void ex03() {
		...
		// 2. Entry를 모두 가져온 뒤, Key와 Value로 분리하기 - 선호
	...
	public static void ex04() { // 연습
		...
		for(int i=0, length=books.size(); i<length; i++) {
			...
			Map<String, Object> book = books.get(i); // arrayList인 경우 .get(i)
